...
app.post('/users', async (req, res) => {
    try {
        ...
        const user = new User({ email, password: hashedPassword,confirm_password: hashedPassword,confirm_password,first_name,last_name,company_name,phone_num,address_line1,address_line2,
        city,state,zip_code });
