...
const createacc_schema = yup.object().shape({
    ...
    phone_num: yup.number("The 'Phone Number' field cannot be blank.").min(10).max(32).required("Please enter your number !"),
    ...
    zip: yup.string().required("The 'Zip/Postcode' field cannot be blank.").min(3)
