...
const Winery = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Winery of the Year</title>
            </Helmet>
            ...
            <div className="container">
                <div className="blog-pages__wrapper">
                    <div className='blog-pages-content'>
                        <Link className='blog-pages__link playfair-font' to='' >Winery of the year</Link>
                        <p className='lato-font' style={{ color: "RGB(176, 151, 109)" }}>15th Feb 2014</p>
                        <Link to='winery'>
                            <img className='blog-pages__img' style={{ width: "100%", height: "100%" }} src="https://cdn11.bigcommerce.com/s-qbep6rt4nh/images/stencil/9999x9999/uploaded_images/blog-post-3.jpg?t=1489064769" alt="winery" />
                        </Link>
