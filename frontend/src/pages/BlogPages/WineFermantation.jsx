...
const WineFermantation = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Wine Fermentation Process</title>
            </Helmet>
            ...
            <div className='blog-pages__top'>
                <span>
                    <p className='lato-font blog-pages-nav' style={{ color: "gray" }}><span style={{ color: "RGB(176, 151, 109)" }}>Home</span>
                        <span style={{ color: "RGB(176, 151, 109)" }}> / Blog</span> / Wine Fermentation Process</p>
                </span>
            </div>
            ...
            <div className="container">
                <div className="blog-pages__wrapper">
                    <div className='blog-pages-content'>
                        <Link className='blog-pages__link playfair-font' to='' >Wine Fermentation Process</Link>
                        <p className='lato-font' style={{ color: "RGB(176, 151, 109)" }}>15th Feb 2014</p>
                        <Link to='winery'>
                            <img className='blog-pages__img' style={{ width: "100%", height: "100%" }} src="https://cdn11.bigcommerce.com/s-qbep6rt4nh/images/stencil/9999x9999/uploaded_images/blog-post-2.jpg?t=1489066586" alt="fermantation" />
                        </Link>
...
export default WineFermantation
