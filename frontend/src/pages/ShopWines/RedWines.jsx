...
const RedWines = () => {
    ...
    useEffect(() => {
        fetch('http://localhost:3070/featured')
            ...
            .then(data => {
                const redWines = data.filter(item => item.kind === "Red");
                setData(redWines);
                setLoading(false);
            })
            .catch(error => {
        ...
        <>
            ...
            <div className='red-wines__top'>
                <div className="container">
                    <span className='red-top__wrapper'>
                        <h2 className='playfair-font' style={{ color: "white" }}>RED WINES</h2>
                        <p className="red-top__article lato-font" style={{ color: "gray" }}>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perferendis libero, nulla minima ipsa ipsam voluptates suscipit adipisci.
                            Animi delectus architecto natus, cupiditate sequi ipsum veniam omnis!</p>
                        <p className='lato-font red-nav' style={{ color: "gray" }}><span style={{ color: "RGB(176, 151, 109)" }}>Home</span>
                            <span style={{ color: "RGB(176, 151, 109)" }}> / Shop Wines</span> / Red Wines</p>
                    </span>
                </div>
            </div>
            ...
            <div className="red-wrapper">
                <div className="container">
                    <div className="row justify-content-between red-content__wrapper">
                        <div className="col-12 col-lg-4">
                            <div className="red-filter__wrapper g-0">
                                                ...
                                                <div className="cards col-6" key={_id}>
                                                    <div className="card-red">
                                                        <div className="redCard-body">
                                                            <img style={{ height: "100%" }} src={image} alt="red wines" />
                                                        </div>
                                                    </div>
