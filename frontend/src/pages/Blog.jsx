      ...
      <div className="container">
        <div className="blog-wrapper">
          <div className='blog-head'>
            ...
            <Link style={{ color: "RGB(176, 151, 109)", textDecoration: "none" }}>read more</Link>
          </div>
        </div>

        <div className="blog-wrapper">
          <div className='blog-head'>
            <Link className='blog-link playfair-font' to='' >When is a vineyard ready for harvest?</Link>
            <p className='lato-font' style={{ color: "RGB(176, 151, 109)" }}>9th Mar 2017</p>
            <Link>
